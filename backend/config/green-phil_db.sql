...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2024 at 09:29 AM
...
INSERT INTO `customer` (`customer_id`, `name`, `email`, `password_hash`, `address`, `phone_number`, `created_at`) VALUES
(1, 'John Doe', 'sample@gmail.com', '$2y$10$BrcUsDMJEXjTnPfDE.zhz.Q2eJ00g3.F9Dln3/NUNF8Aid4wU9.jS', '41 J Rizal St.', '09922588942', '2024-12-01 16:03:20');
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `product_ibfk_1` FOREIGN KEY (`supplier_id`) REFERENCES `admin` (`admin_id`) ON DELETE SET NULL;

--
-- Constraints for table `supplierproduct`
--
ALTER TABLE `supplierproduct`
  ADD CONSTRAINT `supplierproduct_ibfk_1` FOREIGN KEY (`admin_id`) REFERENCES `admin` (`admin_id`) ON DELETE CASCADE,
  ADD CONSTRAINT `supplierproduct_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `product` (`product_id`) ON DELETE CASCADE;
COMMIT;
